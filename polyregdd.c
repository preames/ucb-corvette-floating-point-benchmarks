...
void dgefa(int lda, int n, long double a[lda][n], int ipvt[], int info); 

void dgesl(int lda, int n, long double a[lda][n], int ipvt[], long double b[], int job);

void daxpy(int n, long double da, long double dx[], int incx, long double dy[], int incy);

void dscal(int n, long double da, long double dx[], int incx);

void dmxpy(int n1, double y[], int n2, int ldm, double x[], double m[ldm][n2]);

double ddot(int n, long double dx[], int incx, long double dy[], int incy);

int idamax(int n, long double dx[], int incx);
...
int main() {
	...
	long double c[n], r[n], x[n][n], v[n], v1[n], t1, t2, t3, t4;
